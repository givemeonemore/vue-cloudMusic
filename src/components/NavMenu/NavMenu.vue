<template>
  <div class="menu-content">
      ...
      >
        <el-submenu index="1">
          ...
          <el-menu-item index="1-1">
            ...
            <span class="menu-content-menu-item-title" slot="title">发现音乐</span>
          </el-menu-item>
          <el-menu-item index="1-2">
            <span ref="menuItem1-2"></span>
            <i class="iconfont icon-fm"></i>
            <span class="menu-content-menu-item-title" slot="title">私人FM</span>
          </el-menu-item>
        ...
        <el-submenu index="2">
          ...
          <el-menu-item index="2-1">
            ...
            <span class="menu-content-menu-item-title" slot="title">本地音乐</span>
          </el-menu-item>
          <el-menu-item index="2-2">
            <span ref="menuItem2-2"></span>
            <i class="iconfont icon-xiazaiguanli"></i>
            <span class="menu-content-menu-item-title" slot="title">下载管理</span>
          </el-menu-item>
          <el-menu-item index="2-3">
            <span ref="menuItem2-3"></span>
            <i class="iconfont icon-yunpan"></i>
            <span class="menu-content-menu-item-title" slot="title">我的音乐云盘</span>
          </el-menu-item>
          <el-menu-item index="2-4">
            <span ref="menuItem2-4"></span>
            <i class="iconfont icon-wodeshoucang"></i>
            <span class="menu-content-menu-item-title" slot="title">我的收藏</span>
          </el-menu-item>
        </el-submenu>
        <el-submenu index="3">
          <template slot="title">
          ...
          <el-menu-item index="3-1">
            ...
            <span class="menu-content-menu-item-title" slot="title">我喜欢的音乐</span>
          </el-menu-item>
          <el-menu-item :index="item.key" :key="key" v-for="(item, key) in createMusicLists" >
            <span :ref="item.refKey"></span>
            <i class="iconfont icon-playlist"></i>
            <span class="menu-content-menu-item-title" slot="title">{{item.name}}</span>
          </el-menu-item>
        </el-submenu>
        <el-submenu index="4">
          <template slot="title">
          ...
          <el-menu-item :index="item.key" :key="key" v-for="(item, key) in collectMusicLists" >
            <span :ref="item.refKey"></span>
            <i class="iconfont icon-playlist"></i>
            <span class="menu-content-menu-item-title" slot="title">{{item.name}}</span>
          </el-menu-item>
    ...
    <div class="menu-content-collapse" v-model="isCollapse" @click="handleCollapse">
...
export default class NavMenu extends Vue {
  ...
  // TODO 收藏的歌单，目前是写死测试。
  collectMusicLists: Array<object> = [
    {
      "name": "收藏的歌单1",
      "key": "4-1",
      "refKey": "menuIten4-1"
  ...
  // methods
  handleCollapse() {
     this.collapseDirection = (this.collapseDirection === "icon-zuo") ? "icon-you" : "icon-zuo";
     this.isCollapse = (this.isCollapse === false) ? true : false;
     this.menuContentAreaCollapse = (this.menuContentAreaCollapse === "menu-content-area") ? "menu-content-area-collapse" : "menu-content-area";
  }
  ...
  selectItem(index: string) {
    ...
    for (let key in refs) {
      if (key.indexOf(index) > -1) {
        this.$nextTick(() => {
          (refs[key] as any).className = "menu-content-menu-item-left-select-item";
          // 初始化进来的时候，可能会出现dom树渲染的时候
          let clickName = (refs[key] as any).parentElement.children[(refs[key] as any).parentElement.children.length - 1].innerHTML;
          let cloudMusicChildRouter = vm.$router.options.routes[1].children[0].children;
